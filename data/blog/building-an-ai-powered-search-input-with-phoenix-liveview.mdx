---
title: "Building an AI-Powered Search Input With Phoenix LiveView"
date: "2025-02-23"
...
##### **1️⃣ Setting Up the Module and AI Model**
...
- `@moduledoc` → Provides a high-level description of what this module does.
- Module follows Elixir’s naming convention under `PhoenixLiveViewAiFiltersPoc.Projects.Services`.
...
## **✨ Final Challenge: Try It in Your Own Project!**
