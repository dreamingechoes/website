        ...
        <div className="container py-12">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
            ...
            <div className="mt-4 flex gap-3">
              <a
                ...
                download
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-purple hover:bg-purple-700 dark:hover:bg-purple-500"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium leading-5 transition-colors duration-150 bg-stone-50 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-stone hover:bg-stone-200 dark:hover:bg-stone-100 dark:hover:text-gray-800 text-gray-700 shadow focus:shadow-outline-stone"
              >
          ...
          <div className="mt-8 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg p-6">
            ...
            <div className="mt-6">
              ...
              <blockquote className="mt-4 border-l-4 border-primary-500 pl-4 italic text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg">
              ...
              <ul className="mt-3 space-y-2">
                ...
                <li className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
                  <CheckCircle2 className="w-4 h-4 text-primary-500 mt-0.5 flex-shrink-0" />
                  <span>Advocate for DEI, mental health & inclusive tech communities</span>
                </li>
              </ul>
            </div>
          </div>
