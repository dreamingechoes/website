...
export default function PostLayout({
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setReadingProgress(docHeight > 0 ? Math.min(100, (yOffset / docHeight) * 100) : 0)
    }
  ...
  const handleCopyFeed = async () => {
    try {
      await navigator.clipboard.writeText(`${siteMetadata.siteUrl}/feed.xml`)
      setCopiedFeed(true)
  ...
  return (
    <>
      <div
        className="fixed top-0 left-0 z-50 h-1 w-full origin-left bg-primary-500 will-change-transform"
                  ...
                  <div className="not-prose rounded-2xl border border-primary-200 bg-gradient-to-br from-primary-50 to-white p-6 shadow-sm dark:border-primary-500/30 dark:from-primary-900/20 dark:to-gray-900 sm:p-8">
                    <div className="mb-6 text-center sm:text-left">
                      ...
                      <p className="text-gray-600 dark:text-gray-400">
                        Follow along in your favourite feed reader. Every new post lands there as
